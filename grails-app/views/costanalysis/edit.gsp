...
<html>
	...
	<body>
		<a href="#edit-costanalysis" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-costanalysis" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${costanalysisInstance?.version}" />
				<fieldset class="form">
