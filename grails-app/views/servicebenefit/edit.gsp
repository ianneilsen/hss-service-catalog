...
<html>
	...
	<body>
		<a href="#edit-servicebenefit" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-servicebenefit" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${servicebenefitInstance?.version}" />
				<fieldset class="form">
