...
<html>
    ...
    <div class="eso-inner">
		...
		<div id="edit-servicecatagory" class="content scaffold-edit" role="main">
			<div class="breadcrumb"><h3><g:message code="default.edit.label" args="[entityName]" /></h3></div>

            <g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${servicecatagoryInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${servicecatagoryInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${servicecatagoryInstance?.version}" />
				<fieldset class="form">
