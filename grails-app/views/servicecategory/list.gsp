			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="categoryname" title="${message(code: 'servicecategory.categoryname.label', default: 'Categoryname')}" />
				...
				<g:each in="${servicecategoryInstanceList}" status="i" var="servicecategoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${servicecategoryInstance.id}">${fieldValue(bean: servicecategoryInstance, field: "categoryname")}</g:link></td>
