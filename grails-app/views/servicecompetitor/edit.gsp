...
<html>
	...
	<body>
		<a href="#edit-servicecompetitor" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-servicecompetitor" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${servicecompetitorInstance?.version}" />
				<fieldset class="form">
