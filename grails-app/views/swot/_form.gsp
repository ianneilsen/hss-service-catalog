...
<div class="fieldcontain ${hasErrors(bean: swotInstance, field: 'strength', 'error')} ">
	...
	<g:textArea name="strength" cols="40" rows="5" maxlength="500" value="${swotInstance?.strength}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: swotInstance, field: 'weaknesses', 'error')} ">
    ...
    <g:textArea name="weaknesses" cols="40" rows="5" maxlength="500" value="${swotInstance?.weaknesses}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: swotInstance, field: 'opportunities', 'error')} ">
	...
	<g:textArea name="opportunities" cols="40" rows="5" maxlength="500" value="${swotInstance?.opportunities}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: swotInstance, field: 'threats', 'error')} ">
	...
	<g:textArea name="threats" cols="40" rows="5" maxlength="500" value="${swotInstance?.threats}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: swotInstance, field: 'gaps', 'error')} ">
	...
	<g:textArea name="gaps" cols="40" rows="5" maxlength="500" value="${swotInstance?.gaps}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: swotInstance, field: 'swotnumber', 'error')} ">
    <label for="swotnumber">
        <g:message code="swot.swotnumber.label" default="Swot number" />

    </label>
    <g:textField name="swotnumber" value="${swotInstance?.swotnumber}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: swotInstance, field: 'teamservices', 'error')} required">
	...
	<g:select id="teamservices" name="teamservices.id" from="${hss.service.catalog.Teamservice.list()}" optionKey="id" required="" value="${swotInstance?.teamservices?.id}" class="many-to-one"/>
</div>
