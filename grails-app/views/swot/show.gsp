...
%{--				<li><g:link class="list" action="list"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
                ...
                <li><g:link  action="show" controller="teamservice" id="${swotInstance?.teamservices?.id}"><g:message code="Back to ${swotInstance?.teamservices?.encodeAsHTML()}" args="[entityName]" /></g:link></li>
			</ul>
		</div>
